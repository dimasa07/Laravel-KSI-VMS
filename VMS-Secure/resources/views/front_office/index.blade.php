...
@section('title','Front Office - Dasbor')
    ...
    <div class="w-full px-4 md:px-0 md:mt-8 mb-16 text-gray-800 leading-normal">
        ...
        <div class="flex flex-row flex-wrap flex-grow mt-2">
            <div class="w-full md:w-1/2 p-3">
                ...
                <div class="bg-white border rounded shadow">
                    <div class="border-b p-3">
                        <h5 class="font-bold uppercase text-gray-600">Check-In hari ini</h5>
                    </div>
                    <div class="p-5">
                        <table class="w-full p-5 text-gray-700 border-3 border-black">
                            ...
                            <body>
                                @for($i = 0 ; $i < count($dataCheckInHariIni); $i++) <tr>
                                    <td class="border-2 p-2 text-center">{{ $i+1 }}</td>
                                    <td class="border-2 p-2">{{ $dataCheckInHariIni[$i]->permintaan_bertamu->tamu->nama }}</td>
                                    <td class="border-2 p-2">{{ $dataCheckInHariIni[$i]->permintaan_bertamu->tamu->nik }}</td>
                                    <td class="border-2 p-2 text-center">{{ $dataCheckInHariIni[$i]->check_in }}</td>
                                    </tr>
                                    @endfor
                            </body>
                        </table>
            ...
            <div class="w-full md:w-1/2 p-3">
                ...
                <div class="bg-white border rounded shadow">
                    <div class="border-b p-3">
                        <h5 class="font-bold uppercase text-gray-600">Check-out hari ini</h5>
                    </div>
                    <div class="p-5">
                        <table class="w-full p-5 text-gray-700 border-3 border-black">
                            ...
                            <body>
                                @for($i = 0 ; $i < count($dataCheckOutHariIni); $i++) <tr>
                                    <td class="border-2 p-2 text-center">{{ $i+1 }}</td>
                                    <td class="border-2 p-2">{{ $dataCheckOutHariIni[$i]->permintaan_bertamu->tamu->nama }}</td>
                                    <td class="border-2 p-2">{{ $dataCheckOutHariIni[$i]->permintaan_bertamu->tamu->nik }}</td>
                                    <td class="border-2 p-2 text-center">{{ $dataCheckOutHariIni[$i]->check_out }}</td>
                                    </tr>
                                    @endfor
                            </body>
                        </table>
