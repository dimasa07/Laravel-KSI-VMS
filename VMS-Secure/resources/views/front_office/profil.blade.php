...
<div class="container w-full mx-auto pt-20">
    <div class="w-full px-4 md:px-0 md:mt-8 mb-16 text-gray-800 leading-normal">
        ...
        <div class="w-full p-3">
            <!--Table Card-->
            <div class="bg-white border rounded shadow">
                <div class="p-5" x-data="{ showFormEdit : false, frontOffice:{{$frontOffice}}, showAlert:true }">
                    ...
                    <form method="POST" @submit.prevent="submit()">
                        <div class="relative pb-11 px-6">
                            ...
                            <div class="inline-flex absolute right-0 bottom-0">
                                ...
                                <button type="button" x-show="!showFormEdit" @click="showFormEdit= !showFormEdit; frontOffice={{$frontOffice}}; showAlert=false" class=" bg-blue-600 hover:bg-blue-800 text-white py-1 px-2 rounded mx-2">Edit Profil</button>
